...
<body>
<div>
    <form class="cont"  name="zac_data" action="save_data_auto.php" method="POST">
        <div class="block-div">
      ...
      <div class="u-form-group u-form-group block-div">
        ...
        if(isset($_SESSION['message_image']))
        {
            echo '<p class="mes" style="color: #CC0000">' .$_SESSION['message_image']. '</p>';
        }
        unset($_SESSION['message_image']);
        if(isset($_SESSION['mes']))
        {
            echo '<p class="mes" style="color: #CC0000">' .$_SESSION['mes']. '</p>';
        }
        unset($_SESSION['mes']);
        ...
        if(isset($_SESSION['size_height']))
        {
            echo '<p class="mes" style="color: #CC0000">'. "size_height ".$_SESSION['size_height']. '</p>';
        }
        unset($_SESSION['size_height']);
        if(isset($_SESSION['size_wight']))
        {
            echo '<p class="mes" style="color: #CC0000">' ."size_wight".$_SESSION['size_wight']. '</p>';
        }
        unset($_SESSION['size_wight']);
        ?>
    </form>
